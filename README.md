...
The package is not yet ECMA-402 conformant. Locale identifier construction, likely-subtag operations, and text direction are implemented: the public layers validate the full Unicode locale-identifier grammar, apply all eleven constructor options, preserve extensions, expose the canonical identifier properties, and provide deterministic `maximize()`, `minimize()`, and `getTextInfo()` results. Other locale-information methods remain unfinished.
