...
return static function (FixtureCatalogContext $context): array {
    $mappedStatePipeline = $context->mappedStatePipeline;
    $stateExpectations = $context->stateExpectations;
    ...
    return [
        ...
        'test/intl402/Locale/constructor-options-calendar-invalid.js' => $mappedOptionPipeline(
            ...
            'ConstructorOptionsCalendarInvalidTest',
            $invalidCases(array_map($stringValue, ['', 'a', 'ab', 'abcdefghi', 'abc-abcdefghi'])),
        ),
        'test/intl402/Locale/constructor-options-calendar-valid.js' => $mappedOptionPipeline(
            'calendar',
            'e30190ad76b38bdd07d9ce24529ac7b34d6da320e0df07272dd57195e2084517',
            'ConstructorOptionsCalendarValidTest',
            $optionCases($forKeyword('ca'), [
                [0, 'en',              null],
                [1, 'en-u-ca-gregory', null],
            ]),
        ),
        'test/intl402/Locale/constructor-options-collation-invalid.js' => $mappedOptionPipeline(
            'collation',
            'bfa787a24721a492dbfc3a4cf18987a6ceb90b31ffe25a203d38978ac1954c80',
            'ConstructorOptionsCollationInvalidTest',
            $invalidCases(array_map($stringValue, ['', 'a', 'ab', 'abcdefghi', 'abc-abcdefghi'])),
        ),
        'test/intl402/Locale/constructor-options-collation-valid.js' => $mappedOptionPipeline(
            'collation',
            'e1b6b330d62172e723ac79708bdd013c9559d80f1504e8057a86a74e78b08e4a',
            'ConstructorOptionsCollationValidTest',
            $optionCases($forKeyword('co'), [
                [0, 'en',              null],
