    ...
    public static function installFromDirectory(string $packageDirectory): void
    {
        ...
        try {
            ...
            self::run([
                PHP_BINARY,
                '-r',
                'require "vendor/autoload.php"; $locale = new Midnight\\Intl\\Locale("AR-arab-at"); if ($locale->toString() !== "ar-Arab-AT" || $locale->getTextInfo()->direction !== Midnight\\Intl\\TextDirection::RightToLeft || $locale->getTimeZones() !== ["Europe/Vienna"] || (new Midnight\\Intl\\Locale("en"))->getTimeZones() !== null) { exit(1); }',
            ], $consumerDirectory);
        } finally {
